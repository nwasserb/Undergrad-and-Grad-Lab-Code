##################################################################
# Current Best code as of 11-12-24                               #
# - Matt                                                         #
##################################################################
...
class CustomEPCOptimizer:
    ...
    def __init__(self, detector_session, epc_feedback_session, max_iterations=400, initial_step_size=100, refinement_step_size=10, repeat_iterations=10):
        ...
        self.SLEEP_TIME = 0.1 # changed from .05 due to a timeout at 531 iterations
    ...
    def MATT(self, initial_voltages): # Manifold-Adaptive Tensorial Transformation
...
def main():
    ...
    name = fr'C:\Users\Alice1\Documents\Custom Algorithm Optimization\DO NOT TOUCH THESE FILES\BOB_Optimization_Values_{timestamp}.csv'
